...
cnt = 0  # Счетчик количества успешно созданных кораблей
...
class Board:
    ...
    @classmethod  # Создаем игровое поле 6х6
...
class Ship:
    def __init__(self, d):
        self.d = d  # d - количество клеток корабля
    ...
    @classmethod  # расстановка кораблей на игровом поле и проверка их количеста
...
while win_flag:
    ...
    try:
        ...
        if not (1 <= x <= 6 and 1 <= y <= 6):
            print('Вы ввели не правильный номер строки или столбца.')
            continue
    except ValueError:
        print('Вы ошиблись при вводе. Внимательнее, пожалуйста! ')
        continue
